...
import { casesHandled, createContextualError } from './utils.js';
 ...
 */
export const parse = (defaults, pattern) => {
 ...
 */
export const parseOne = (criteriaDefaults, pattern) => {
    ...
    if (path.value !== null) {
        ...
        if (invalidPathPartNames.length) {
            return createInvalidPattern(originalInput, `Path segment names must only contain ${String(validPathSegmentNameRegex)}.`);
        }
    }
 ...
 */
export const test = (patterns, log) => {
    let yaynay = null;
 ...
 */
export const parseUnsafe = (defaults, pattern) => {
 ...
 */
export const renderSyntaxManual = () => {
...
export const processLogFilterInput = (defaults, pattern, foundIn) => {
