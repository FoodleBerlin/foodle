import * as Filter from './filter.cjs';
import * as Level from './level.cjs';
import * as Output from './output.cjs';
 ...
 */
export declare const processSettingInputData: (data: NonNullable<Input['data']>, previous: null | Data['data']) => Data['data'];
/**
 * Process pretty setting input.
 */
export declare const processSettingInputPretty: (pretty: Input['pretty'], previous: null | Data['pretty']) => Data['pretty'];
export declare const create: (opts?: Input) => Manager;
export declare const processSettingInputFilter: (newSettingsFilter: NonNullable<Input['filter']>, prev: null | Data['filter']) => Data['filter'];
export declare const defaultFilterSetting: () => Data['filter'];
