...
export declare function generateRuntimeAndEmit(dmmf: DMMF.Document, settings: Gentime.Settings): void;
/** Transform the given DMMF into JS source code with accompanying TS declarations. */
export declare function generateRuntime(dmmf: DMMF.Document, settings: Gentime.Settings): ModuleSpec[];
