...
function enumMissingDocGuide(enum_) {
    return (0, dindist_1.default) `
...
function modelMissingDocGuide(model) {
...
function fieldExample({ model, field }) {
    return (0, dindist_1.default) `
    * @example
    *
    * import { objectType } from 'nexus'
 ...
 * Helpers
 */
function missingDocsIntro(info) {
