...
exports.fieldTypeToGraphQLType = exports.renderTypeScriptDeclarationForDocumentModels = exports.createModuleSpec = void 0;
...
const createModuleSpec = (dmmf, settings) => {
    return {
        fileName: 'index.d.ts',
...
`;
function renderTypeScriptDeclarationForDocumentModels(dmmf, settings) {
    ...
    return ((0, dindist_1.default) `
      ...
      import { Runtime } from ${settings.data.output.directory === 'default'
...
function renderTypeScriptDeclarationForEnum(enum_, settings) {
...
function renderTypeScriptDeclarationForModel(model, settings) {
...
function renderTypeScriptDeclarationForModelFields(model, settings) {
    return model.fields
        .map((field) => renderTypeScriptDeclarationForField({ field, model, settings }))
        .join('\n');
}
function renderTypeScriptDeclarationForField({ field, model, settings, }) {
...
function renderNexusType(field, settings) {
 ...
 */
function fieldTypeToGraphQLType(field, settings) {
