...
export function createNexusTypeDefConfigurations(dmmf, settings) {
    return {
...
export function prismaFieldToNexusType(field, settings) {
 ...
 */
export function nexusResolverFromPrismaField(model, field, settings) {
