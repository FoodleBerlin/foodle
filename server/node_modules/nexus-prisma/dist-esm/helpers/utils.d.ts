export declare type Resolver = (root: RecordUnknown, args: RecordUnknown, ctx: RecordUnknown) => MaybePromise<unknown>;
export declare type MaybePromise<T> = T | Promise<T>;
export declare type RecordUnknown<T = unknown> = Record<string, T>;
