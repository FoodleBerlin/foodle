 ...
 * ```
 */
export const TypeScriptOrmCompoundUniquePropertyName = (fieldNames) => fieldNames.join('_');
/**
 ...
 */
export const typeScriptOrmModelPropertyNameFromModelName = (modelName) => lowerFirst(modelName);
