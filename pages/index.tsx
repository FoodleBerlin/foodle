...
const Home: NextPage = () => {
  ...
  return (
    <div>
      ...
      <div className={styles['hero']}>
        <div className={styles['hero__left']}>
          <div className={styles['hero__left--inner']}>
            <h1 className={'header-primary'}>Renting Licensed Kitchen Space is about to get way easier.</h1>
            <h1 className={'body-text'}>
              Foodle is being cooked right now. Stay tuned for our launch by submitting your email!
            </h1>
            <div>
              <input
      ...
      <h2 className={styles['random-text'] + ' header-secondary'}>Make your entrepreneurial food dreams come true.</h2>
