...
exports.FindPropertyById = exports.FindPropertyResult = exports.findAllProperties = exports.findAllPropertiesReturn = void 0;
...
exports.FindPropertyById = (0, nexus_1.extendType)({
    ...
    definition: function (t) {
        ...
        t.field('findProperty', {
            ...
            args: {
                handle: (0, nexus_1.nonNull)((0, nexus_1.stringArg)()),
            },
            resolve: function (_, args, ctx) { return __awaiter(_this, void 0, void 0, function () {
                var prop;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, validatorService_1.ValidatorService.propertyExists(args.handle)];
                        case 1:
                            prop = _a.sent();
                            if (prop === null) {
                                return [2 /*return*/, {
