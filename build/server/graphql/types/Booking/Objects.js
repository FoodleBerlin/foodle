...
var Objects_1 = require("../DaySlot/Objects");
...
exports.Booking = (0, nexus_1.objectType)({
    ...
    definition: function (t) {
        ...
        t.list.field('daySlots', {
            type: Objects_1.DaySlot,
            resolve: function (parent, args, ctx) {
                return __awaiter(this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, ctx.prisma.daySlot.findMany({
                                    where: {
        ...
        t.field('bookingStatus', { type: Enums_1.BookingStatusEnum });
        t.field('frequency', { type: Enums_1.FrequencyEnum });
        t.float('totalPrice');
        t.string('startDate');
        t.string('endDate');
    },
