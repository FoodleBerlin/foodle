...
exports.FindBookingsOfUser = exports.GetBookingsOfUser = void 0;
var nexus_1 = require("nexus");
var validatorService_1 = require("../../../singletons/validatorService");
var Error_1 = require("../Error");
exports.GetBookingsOfUser = (0, nexus_1.objectType)({
...
exports.FindBookingsOfUser = (0, nexus_1.extendType)({
    type: 'Query',
    definition: function (t) {
        var _this = this;
        t.field('findBookingsOfUser', {
            type: exports.GetBookingsOfUser,
            ...
            resolve: function (_, args, ctx) { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        ...
                        case 2: return [4 /*yield*/, ctx.prisma.booking.findMany({
                                where: {
                                    tenantId: user.id,
                                },
                            })];
                        case 3:
                            bookings = _c.sent();
                            return [2 /*return*/, { Bookings: bookings }];
                    }
                });
            }); },
        });
