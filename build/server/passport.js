...
passport_1.default.use(new GoogleStrategy({
    ...
    return __awaiter(this, void 0, void 0, function () {
        var user, stripeId, res, e_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 6, , 7]);
                    if (!accessToken || !profile)
                        return [2 /*return*/, cb('error', null)];
                    return [4 /*yield*/, prisma_1.default.user.findUnique({
                            where: {
                                email: (_a = profile === null || profile === void 0 ? void 0 : profile.emails[0].value) !== null && _a !== void 0 ? _a : '',
                            },
                        })];
                case 1:
                    user = _b.sent();
                    ...
                    return [4 /*yield*/, stripeWrapper.createCustomer({ email: profile.emails[0].value })];
                case 2:
                    stripeId = _b.sent();
