...
var ProfileForm_1 = __importDefault(require("../../components/Profile/ProfileForm"));
...
var Profile = function (props) {
    ...
    }, { handle: props.session.email }, {}), findUserData = _a.data, status = _a.status, error = _a.error, isFetching = _a.isFetching;
    var isMounted = (0, react_1.useRef)(false);
    return (<div className={Account_module_scss_1.default['account']}>
      <Navbar_1.default user={props.session}/>
      <Sidebar_1.default />
      <main>
        <ProfileForm_1.default session={props.session} isMountedRef={isMounted} jwt={props.jwt} user={findUserData}/>
      </main>
    </div>);
};
