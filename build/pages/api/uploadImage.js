...
var Uploader_1 = require("../../components/Create/Uploader");
function handler(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var _this = this;
        return __generator(this, function (_a) {
            Uploader_1.s3.listObjectsV2({ Bucket: 'foodle-bucket' }, function (err, data) { return __awaiter(_this, void 0, void 0, function () {
                var post;
                return __generator(this, function (_a) {
                    if (data.Contents.length < 100) {
                        try {
                            console.log("gettin 'ere");
                            post = Uploader_1.s3.createPresignedPost({
