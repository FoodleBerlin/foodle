...
var getResourceUrl = function (file) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, fetch("/api/getImage?file=" + (file ? file.name : ''))];
            case 1:
...
function handler(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            try {
                imageUrl = uploadImage_1.s3.getSignedUrl('getObject', {
                    Bucket: 'foodle-bucket',
                    Key: req.query.file,
                });
                return [2 /*return*/, res.status(200).json({ imageUrl: imageUrl })];
            }
            catch (error) {
                console.log(error);
            }
