...
describe('Update User', function () {
    ...
    describe('with valid data', function () {
        it('returns user if succeeded', function () { return __awaiter(void 0, void 0, void 0, function () {
            var res;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    describe('with invalid data-', function () {
        it('id does not return user', function () { return __awaiter(void 0, void 0, void 0, function () {
            var res;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, index_1.apollo.executeOperation({
