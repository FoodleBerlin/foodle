...
function Step4() {
    ...
    return (<div className={Create_module_scss_1.default['main']}>
      ...
      <div className={Create_module_scss_1.default['drag-drop']}>
        <Uploader_1.default idCount={idCount} setImages={function (images) { return setImages(images); }} imageAmount={images.length} setIdCount={function (id) { return setIdCount(id); }} images={images}/>
        {images.length > 0 ? (<Preview_1.default setImages={function (images) { return setImages(images); }} deleteImage={function (id) { return deleteImage(id); }} images={images}/>) : null}
      </div>
    </div>);
}
