...
var ProfileButton = function (props) {
    ...
    return !props.alreadyUploaded ? (<aside className={Account_module_scss_1.default['account__document-btns'] + ' mt-two'}>
      ...
      <input id="upload" type="file" value={(_a = props.image) === null || _a === void 0 ? void 0 : _a.file} onChange={function (e) {
            var _a;
      ...
      <a href={getSignedUrl(((_b = props === null || props === void 0 ? void 0 : props.image) === null || _b === void 0 ? void 0 : _b.s3Id) ? (_c = props.image) === null || _c === void 0 ? void 0 : _c.s3Id : '')} download>
