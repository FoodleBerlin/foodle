...
export default function Step3() {
  ...
  return (
    <div className={styles['step3']}>
      ...
      <div className={styles['formItem']}>
        <h2 className={'header-secondary'}>Is there a service fee?</h2>
        <p className="body-text-secondary">
      ...
      <div className={styles['formItem']}>
        <h2 className="header-secondary">Will pickup be possible?</h2>
        <div className={styles['step3__buttonWrapper']}>
          <input
            {...register('pickup')}
            type="radio"
            id="pickup-no"
